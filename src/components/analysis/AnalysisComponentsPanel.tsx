...
interface AnalysisComponentsPanelProps {
  config?: any;
  onManageComponents: () => void;
}

const AnalysisComponentsPanel: React.FC<AnalysisComponentsPanelProps> = ({
  config,
  onManageComponents,
}) => {
...
export default AnalysisComponentsPanel;